        ...
        for item in data:
            ...
            try:
                storage_context = StorageContext.from_defaults(
                    persist_dir=f"./circulaire_prod_chimie_store/{circular_number}"
                )
                ...
                # Persist index
                index.storage_context.persist(persist_dir=f"./circulaire_prod_chimie_store/{circular_number}")
            ...
            tool = QueryEngineTool(
                ...
                metadata=ToolMetadata(
                    ...
                    description=(
                        f"tool contient le circulaire qui est sur:{objet}"
                    ),
                ),
            )
