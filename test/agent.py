...
Docs_Required_tool = FunctionTool.from_defaults(
    fn=Docs_Required,
    description="useful for searching for required documents for importing a product,takes in a natural language as input,DO NOT use a sql commmand."
)


agent = ReActAgent.from_tools([NL_2_SQL_tool], llm=llm, verbose=True)
